...
public class RestExceptionProcessor {
	...
	@ResponseBody
	public ErrorInfo clientNotFound(HttpServletRequest req, ClientNotFoundException ex) {
		
		String errorMessage = localizeErrorMessage("error.no.client.id");
		
		errorMessage += ex.getClientId();
