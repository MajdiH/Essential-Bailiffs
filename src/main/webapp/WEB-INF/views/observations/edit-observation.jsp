                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group ">
                                                ...
                                                <div class="controls visible-desktop">
                                                    <textarea id="statement" name="statement">${observation.statement }</textarea>
                                                </div>
                                            ...
                                            <div class="control-group ">
                                                ...
                                                <div class="controls visible-desktop">
                                                    <textarea id="comment" name="comment">${observation.comment }</textarea>
                                                </div>
												<div class="controls visible-tablet visible-phone">
                                                    <textarea name="comment">${observation.comment }</textarea>
                                                </div>
                                            </div>
											...
											$
													.ajax({
														...
														success : function(observation) {
															...
															respContent += "le  <strong>Constat</strong> est bien modifié : [";
